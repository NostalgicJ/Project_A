...
# (기존 코드) for i in range(start_iter, opt.num_iter + 1):
# (기존 코드)     ... (학습 루프) ...

# (이 루프가 끝난 직후)
# --- [수정/추가] 마지막 모델 저장 ---
print("Training finished. Saving final model...")
torch.save(model.state_dict(), f'./saved_models/{opt.exp_name}/final_model.pth')
# --- [수정/추가] ---

# (기존 코드) if __name__ == '__main__':
# (기존 코드)     ...
